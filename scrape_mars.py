...
def scrape_info():
    ...
    #Add to dictionary
    mars_dict['marsnews_url_title'] = marsnews_url_title
    mars_dict['marsnews_url_paragraph'] = marsnews_url_paragraph
    ...
    #Add to dictionary
    mars_dict['featuredimage_url'] = featuredimage_url
